...
Reader.prototype.float = function read_float() {
    ...
    var value = null;
    if (window && true == window.forceBigEndianFloatingNumDecoding) {
      value = util.float.readFloatBE(this.buf, this.pos);
    } else {
      value = util.float.readFloatLE(this.buf, this.pos);
    }
    this.pos += 4;
    return value;
};
...
Reader.prototype.double = function read_double() {
    ...
    var value = null;
    if (window && true == window.forceBigEndianFloatingNumDecoding) {
      value = util.float.readDoubleBE(this.buf, this.pos);
    } else {
      value = util.float.readDoubleLE(this.buf, this.pos);
    }
    this.pos += 8;
    return value;
};
