"use strict";
cc._RF.push(module, '91a92+38GpLfoQ463Q+5J5O', 'TileCollisionManagerSingleton');
// scripts/TileCollisionManagerSingleton.js
...
TileCollisionManager.prototype._continuousFromCentreOfDiscreteTile = function (tiledMapNode, tiledMapIns, layerIns, discretePosX, discretePosY) {
  ...
  switch (mapOrientation) {
    ...
    case cc.TiledMap.Orientation.ISO:
      ...
      mapAnchorOffset = cc.v2(tiledMapNode.getContentSize().width * (0.5 - tiledMapNode.getAnchorPoint().x), tiledMapNode.getContentSize().height * (1 - tiledMapNode.getAnchorPoint().y));
      layerOffset = cc.v2(0, 0);
      var transMat = [[cosineThetaRadian, -cosineThetaRadian], [-sineThetaRadian, -sineThetaRadian]];
...
TileCollisionManager.prototype.continuousObjLayerVecToContinuousMapNodeVec = function (withTiledMapNode, continuousObjLayerVec) {
  ...
  switch (mapOrientation) {
    ...
    case cc.TiledMap.Orientation.ISO:
      ...
      var transMat = [[isometricObjectLayerPointOffsetScaleFactor * cosineThetaRadian, -isometricObjectLayerPointOffsetScaleFactor * cosineThetaRadian], [-isometricObjectLayerPointOffsetScaleFactor * sineThetaRadian, -isometricObjectLayerPointOffsetScaleFactor * sineThetaRadian]];
